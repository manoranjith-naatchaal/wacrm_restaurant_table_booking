...
// Labelled sections rendered below the primary (unlabelled) nav block.
const navGroups: NavGroup[] = [
  {
    title: 'Booking Management',
    items: [
      { href: '/booking', label: 'Overview', icon: Gauge },
      { href: '/reservations', label: 'Reservations', icon: CalendarCheck },
      { href: '/slots', label: 'Slots & Timings', icon: Clock },
      { href: '/exceptions', label: 'Special Hours', icon: CalendarX2 },
      { href: '/tables', label: 'Tables & Seating', icon: Armchair },
    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto px-3 py-4">
          {/* Booking Management first — the primary surface for this app. */}
          {navGroups.map((group) => (
            <div key={group.title}>
              <p className="text-muted-foreground px-3 pb-1.5 text-[10px] font-semibold tracking-wider uppercase">
                {group.title}
              </p>
          ...
          {/* WhatsApp management below booking. */}
          <div>
            <p className="text-muted-foreground px-3 pb-1.5 text-[10px] font-semibold tracking-wider uppercase">
              WhatsApp Management
            </p>
